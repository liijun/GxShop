                ...
                <el-table :data="list" @selection-change="handleSelectionChange" >
                    ...
                    <el-table-column label="商品名称">
                        <template slot-scope="scope">
                            <router-link :to="'/goods/info/'+scope.row.valueId">
                            <dl class="table_dl">
                                <dt><el-image style="width: 50px; height: 50px" :src="scope.row.picUrl"><div slot="error" class="image-slot"><i class="el-icon-picture-outline"></i></div></el-image></dt>
...
export default {
    ...
    methods: {
        ...
        get_fav_list:function(){
            this.$get(this.$api.homeCollectList,{type:0,page:this.current_page}).then(res=>{
        ...
        del:function(fav){
            ...
            this.$post(this.$api.homeAddOrDeleteFav,{type:fav.type,valueId:fav.valueId}).then(res=>{
                if(res.errno == 0){
                    this.get_fav_list();
