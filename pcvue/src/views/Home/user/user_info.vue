    ...
    <div class="user_content_blcok">
        ...
        <div class="admin_form_main">
            <el-form  label-width="100px" ref="info" :model="info">
                ...
                <el-form-item label="头像" prop="avatar"><el-upload class="avatar-uploader" :action="$api.homeUploadImage" :headers="upload_headers" :show-file-list="false" :on-success="handleAvatarSuccess" >
...
export default {
    ...
    methods: {
        ...
        get_user_info:function(){
            this.$get(this.$api.homeAuthInfo).then(res=>{
                this.info = res.data;
            });
        },
        edit_user_info:function(){
            this.$post(this.$api.homeAuthProfile,this.info).then(res=>{
                if (res.errno == 0) {
