<template>
    <div class="qingwu">
        ...
        <div class="shop_content">
            ...
            <div v-for="(v,k) in floorGoodsList" :key="k">
                <shop-index-adv :adv="goods_list_bottom_adv[k]"></shop-index-adv>
                <shop-product-block :floor="v" :adv="goods_list_left_adv[k]"></shop-product-block>
    ...
    methods: {
        ...
        get_index_info:function(){
            this.$get(this.$api.homeGetIndexInfo).then(res=>{
                ...
                this.banner_bottom_adv = res.data.brandList;
