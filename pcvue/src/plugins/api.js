// export const baseUrl="http://123.206.215.59:7001/wx/";
export const baseUrl="http://123.206.215.59/shop/wx/";
export const api = {
    ...
    // 用户登录注册
    "homeLogin" : baseUrl + "auth/login", // 登录
    "homeLogout" : baseUrl + "auth/logout", // 注销账号
    "homeGetOauthConfig" : baseUrl + "user/get_oauth_config", // 获取OAUTH
    "homeRegister" : baseUrl + "auth/register", // 注册
    "homeForgetPassword" : baseUrl + "user/forget_password", // 忘记密码
    "homeRegCaptcha" : baseUrl + "auth/regCaptcha", // 发送短信
    "homeSendEmail" : baseUrl + "user/send_email", // 发送邮件

    "homeGetUserInfo" : baseUrl + "user/get_user_info",// 获取用户信息
    "homeAuthInfo" : baseUrl + "auth/info",// 用户信息
    "homeAuthProfile" : baseUrl + "auth/profile",// 修改用户信息
    "homeCheckPayPassword" : baseUrl + "user/check_pay_password",// 验证支付密码
    "homeCollectList" : baseUrl + "collect/list",// 修改收藏关注列表
    "homeAddOrDeleteFav" : baseUrl + "collect/addordelete",// 删除收藏关注
    ...
    "homeGetSubNavInfo" : baseUrl + "catalog/all", // 获取首页左侧导航的信息
    "homeGetIndexInfo" : baseUrl + "home/index", // 获取首页信息
    ...
    "homeGetGoodsInfo" : baseUrl + "goods/detail",
    // "homeSearchGoods" : baseUrl + "goods/search_goods",
    "homeSearchGoods" : baseUrl + "goods/list",
    "homeGetBrandList" : baseUrl + "brand/list",
    'homeGetCommentList' : baseUrl + "comment/list",  // 获取评论列表根据商品ID
    ...
    // 购物车
    "homeAddCart" : baseUrl + "cart/add",
    "fastAddCart" : baseUrl + "cart/fastadd",
    "homeChangeCart" : baseUrl + "cart/update",
    "homeDelCart" : baseUrl + "cart/delete",
    "homeGetCartList" : baseUrl + "cart/index",
    "homeGetCartCount" : baseUrl + "cart/goodscount",
    "homeCheckedCart" : baseUrl + "cart/checked",
    "homeCheckoutCart" : baseUrl + "cart/checkout",

    // 用户中心
    // "homeGetUserDefault" : baseUrl + "user/get_user_default", // 默认页面
    "homeGetUserIndex" : baseUrl + "user/index", // 默认页面
    // "homeGetUserOrder" : baseUrl + "user/get_user_order", // 默认页面
    "homeGetUserOrder" : baseUrl + "order/list", // 默认页面

    // 用户收货地址
    'getAddressList' : baseUrl + "address/list",
    'addressSave' : baseUrl + "address/save",
    'editAddress' : baseUrl + "address/edit/",
    'delAddress' : baseUrl + "address/delete",
    ...
    'homeAddComment' : baseUrl + "order/comment",  // 添加评论
    // 'homeCommentImage' : baseUrl + "comment/comment_image",  // 图片上传 评论
    'homeUploadImage' : baseUrl + 'storage/upload', //图片上传,
    // 修改订单状态
    ...
    // 预生成订单数据
    'homeGetOrderDetail' : baseUrl + "order/detail",

    // 生成订单
    'homeCreateOrder' : baseUrl + "order/submit",
    ...
    'OrderH5pay' : baseUrl + "order/h5pay",//微信h5
    'OrderWxNativePay' : baseUrl + "order/nativePay",//微信native
    'OrderAliPcPay' : baseUrl + "order/aliPcPay",//aliPcPay
    ...
    // 获取省市区信息
    "homeGetAreaList" : baseUrl + "region/list",
