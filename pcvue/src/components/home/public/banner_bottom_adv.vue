<template>
    <div class="banner_bottom_adv width_center_1200">
        ...
        <div class="shop_right_on">
            <ul>
                <li v-for="(v,k) in index_adv.slice(0, 3)" :key="k"><router-link :to="'/goods/info/'+v.id"><el-image width="312px" height="160px" :src="v.picUrl" :alt="v.name"></el-image></router-link></li>
            </ul>
        </div>
    </div>
</template>
