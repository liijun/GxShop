...
export default new Router({
  ...
  routes: [
      ...
      {path: '/',name: 'home',component: resolve => require(['./views/Home/index.vue'],resolve)},
      ...
      {path: '/order/chose_pay/:orderId',name: 'home_chose_pay',component: () => import('./views/Home/order/chose_pay.vue')},
