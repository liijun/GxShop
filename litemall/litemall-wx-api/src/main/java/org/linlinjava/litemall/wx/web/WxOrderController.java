...
public class WxOrderController {
    ...
    public Object nativePay(@LoginUser Integer userId, @RequestBody String body, HttpServletRequest request) {
        return wxOrderService.nativePay(userId, body, request);
    }
    /**
     * 微信付款成功或失败回调接口
     * <p>
    ...
    public Object aliPcPay(@LoginUser Integer userId, @RequestBody String body, HttpServletRequest request) {
        return wxOrderService.aliPcPay(userId, body, request);
    }
     ...
     * <p>
     *  TODO
     *  注意，这里notifyURL是示例地址，建议开发者应该设立一个隐蔽的回调地址
     *
     * @param request 请求内容
     * @param response 响应内容
     * @return 操作结果
    ...
    public Object notifyURL(HttpServletRequest request, HttpServletResponse response) {
        return wxOrderService.notifyURL(request, response);
    }
}